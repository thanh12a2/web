...
!(function (t, e) {
      ...
      return (
        (e.toggle = function () {
          ...
          e &&
            ...
            t && n(this._element).toggleClass(E);
        }),
        (e.dispose = function () {
        ...
        (t._jQueryInterface = function (e) {
          return this.each(function () {
            var i = n(this).data(_);
            i || ((i = new t(this)), n(this).data(_, i)),
              "toggle" === e && i[e]();
          });
        }),
        o(t, null, [
  ...
  n(document)
    .on(T.CLICK_DATA_API, y, function (t) {
      t.preventDefault();
      var e = t.target;
      n(e).hasClass("btn") || (e = n(e).closest(C)),
        S._jQueryInterface.call(n(e), "toggle");
    })
    .on(T.FOCUS_BLUR_DATA_API, y, function (t) {
      var e = n(t.target).closest(C)[0];
      n(e).toggleClass("focus", /^focus(in)?$/.test(t.type));
    }),
    (n.fn[g] = S._jQueryInterface),
    (n.fn[g].Constructor = S),
      ...
      return (
        ...
        (e._addTouchEventListeners = function () {
          ...
          if (this._touchSupported) {
            var e = function (e) {
                t._pointerEvent && R[e.originalEvent.pointerType.toUpperCase()]
        ...
        (t._jQueryInterface = function (e) {
          return this.each(function () {
            ...
            if (
              (i || ((i = new t(this, o)), n(this).data(I, i)),
              "number" == typeof e)
            )
              i.to(e);
          ...
          if (
            !(
              ...
              (this._parent &&
                ...
                (e = null),
              e && (i = n(e).not(this._selector).data(x)) && i._isTransitioning)
            )
          ) {
            ...
            if ((n(this._element).trigger(r), !r.isDefaultPrevented())) {
              ...
              n(this._element).removeClass(V).addClass(Y),
              ...
              n(this._element)
                .one(a.TRANSITION_END, function () {
                  n(o._element).removeClass(Y).addClass(V).addClass(B),
                    (o._element.style[s] = ""),
                    o.setTransitioning(!1),
                    n(o._element).trigger(Q.SHOWN);
                })
          ...
          if (!this._isTransitioning && n(this._element).hasClass(B)) {
            ...
            if ((n(this._element).trigger(e), !e.isDefaultPrevented())) {
              ...
              (this._element.style[i] =
                ...
                n(this._element).addClass(Y).removeClass(V).removeClass(B);
              ...
              n(this._element)
                .one(a.TRANSITION_END, function () {
                  t.setTransitioning(!1),
                    n(t._element).removeClass(Y).addClass(V).trigger(Q.HIDDEN);
                })
                .emulateTransitionEnd(c);
            }
          }
  ...
  n(document).on(Q.CLICK_DATA_API, z, function (t) {
    ...
    (n.fn[W] = G._jQueryInterface),
    (n.fn[W].Constructor = G),
    (n.fn[W].noConflict = function () {
      ...
      return (
            ...
            if ((t._clearMenus(), !o)) {
              ...
              if ((n(i).trigger(s), !s.isDefaultPrevented())) {
                ...
                "ontouchstart" in document.documentElement &&
                  ...
                  n(this._menu).toggleClass(rt),
                  n(i).toggleClass(rt).trigger(n.Event(it.SHOWN, r));
              }
            }
          }
        }),
        (i.show = function () {
          if (
            !(
              ...
              n(this._element).hasClass(ot) ||
              n(this._menu).hasClass(rt)
            )
          ) {
            ...
            n(o).trigger(i),
              i.isDefaultPrevented() ||
                (n(this._menu).toggleClass(rt),
                n(o).toggleClass(rt).trigger(n.Event(it.SHOWN, e)));
          }
        }),
        (i.hide = function () {
          if (
            ...
            n(o).trigger(i),
              i.isDefaultPrevented() ||
                (n(this._menu).toggleClass(rt),
                n(o).toggleClass(rt).trigger(n.Event(it.HIDDEN, e)));
          }
        }),
        (i.dispose = function () {
          n.removeData(this._element, Z),
            n(this._element).off($),
            (this._element = null),
        ...
        (i._getPlacement = function () {
          ...
          return (
            t.hasClass("dropup")
              ? ((e = "top-start"),
                n(this._menu).hasClass(st) && (e = "top-end"))
              : t.hasClass("dropright")
              ? (e = "right-start")
              : t.hasClass("dropleft")
              ? (e = "left-start")
              : n(this._menu).hasClass(st) && (e = "bottom-end"),
            e
          );
        }),
                ...
                if (
                  ...
                  n(s).trigger(h),
                    h.isDefaultPrevented() ||
                      ...
                      n(c).removeClass(rt),
                      n(s).removeClass(rt).trigger(n.Event(it.HIDDEN, l)));
                }
              }
            }
        }),
              ...
              ? !(
                  ...
                  (27 !== e.which &&
                    ((40 !== e.which && 38 !== e.which) ||
                      n(e.target).closest(lt).length))
                )
              : nt.test(e.which)) &&
            (e.preventDefault(),
            e.stopPropagation(),
            !this.disabled && !n(this).hasClass(ot))
          ) {
  ...
  n(document)
    .on(it.KEYDOWN_DATA_API, at, ut._dataApiKeydownHandler)
    .on(it.KEYDOWN_DATA_API, lt, ut._dataApiKeydownHandler)
    .on(it.CLICK_DATA_API + " " + it.KEYUP_DATA_API, ut._clearMenus)
    .on(it.CLICK_DATA_API, at, function (t) {
      t.preventDefault(),
        t.stopPropagation(),
        ut._jQueryInterface.call(n(this), "toggle");
    })
    .on(it.CLICK_DATA_API, ".dropdown form", function (t) {
      t.stopPropagation();
    }),
    (n.fn[J] = ut._jQueryInterface),
    (n.fn[J].Constructor = ut),
      ...
      return (
        ...
        (e.show = function (t) {
          ...
          if (!this._isShown && !this._isTransitioning) {
            ...
            var i = n.Event(vt.SHOW, { relatedTarget: t });
          ...
          if (
            ...
            if (
              ...
              if (
                ...
                this._setEscapeEvent(),
                this._setResizeEvent(),
                n(document).off(vt.FOCUSIN),
                n(this._element).removeClass(Ct),
                n(this._element).off(vt.CLICK_DISMISS),
                n(this._dialog).off(vt.MOUSEDOWN_DISMISS),
                o)
              ) {
        ...
        (e._showElement = function (t) {
          ...
          (this._element.parentNode &&
            ...
            n(this._element).addClass(Ct),
            this._config.focus && this._enforceFocus();
          var o = n.Event(vt.SHOWN, { relatedTarget: t }),
            r = function () {
        ...
        (e._setEscapeEvent = function () {
          ...
          this._isShown && this._config.keyboard
            ? n(this._element).on(vt.KEYDOWN_DISMISS, function (e) {
        ...
        (e._setResizeEvent = function () {
          var t = this;
          this._isShown
            ? n(window).on(vt.RESIZE, function (e) {
        ...
        (e._hideModal = function () {
          ...
          (this._element.style.display = "none"),
            ...
            (this._isTransitioning = !1),
            this._showBackdrop(function () {
              n(document.body).removeClass(Et),
                t._resetAdjustments(),
                t._resetScrollbar(),
                n(t._element).trigger(vt.HIDDEN);
            });
        }),
        ...
        (e._showBackdrop = function (t) {
          ...
          if (this._isShown && this._config.backdrop) {
            if (
              ...
              n(this._element).on(vt.CLICK_DISMISS, function (t) {
        ...
        (t._jQueryInterface = function (e, i) {
          return this.each(function () {
            ...
            if (
              (o || ((o = new t(this, s)), n(this).data(dt, o)),
              "string" == typeof e)
            ) {
              if (void 0 === o[e])
                throw new TypeError('No method named "' + e + '"');
  ...
  n(document).on(vt.CLICK_DATA_API, '[data-toggle="modal"]', function (t) {
    ...
    var l = n(e).one(vt.SHOW, function (t) {
      t.isDefaultPrevented() ||
        l.one(vt.HIDDEN, function () {
          n(i).is(":visible") && i.focus();
        });
    });
    bt._jQueryInterface.call(n(e), s, this);
  }),
    (n.fn[ft] = bt._jQueryInterface),
    (n.fn[ft].Constructor = bt),
      ...
      return (
        ...
        (i.toggle = function (t) {
          if (this._isEnabled)
            if (t) {
              ...
              if (n(this.getTipElement()).hasClass(Ut))
        ...
        (i.show = function () {
          ...
          if (this.isWithContent() && this._isEnabled) {
            ...
            s.setAttribute("id", l),
              ...
              this.setContent(),
              this.config.animation && n(s).addClass(Rt);
            var c =
        ...
        (i.setContent = function () {
          ...
          this.setElementContent(
            n(t.querySelectorAll(".tooltip-inner")),
            this.getTitle()
          ),
            n(t).removeClass(Rt + " " + Ut);
        }),
        ...
        (i._enter = function (t, e) {
          ...
          (e = e || n(t.currentTarget).data(i)) ||
            ...
            t && (e._activeTrigger["focusin" === t.type ? xt : Wt] = !0),
            n(e.getTipElement()).hasClass(Ut) || e._hoverState === jt
              ? (e._hoverState = jt)
        ...
        (i._leave = function (t, e) {
          ...
          (e = e || n(t.currentTarget).data(i)) ||
            ...
            n(t.currentTarget).data(i, e)),
            t && (e._activeTrigger["focusout" === t.type ? xt : Wt] = !1),
        ...
        (t._jQueryInterface = function (e) {
          return this.each(function () {
            ...
            if (
              ...
              (i || ((i = new t(this, o)), n(this).data(Dt, i)),
              "string" == typeof e)
            ) {
              if (void 0 === i[e])
                throw new TypeError('No method named "' + e + '"');
  ...
  (n.fn[It] = Ft._jQueryInterface),
    (n.fn[It].Constructor = Ft),
  ...
  var qt = "popover",
    ...
    Xt = r({}, Ft.DefaultType, { content: "(string|element|function)" }),
    zt = {
      HIDE: "hide" + Kt,
      HIDDEN: "hidden" + Kt,
      SHOW: "show" + Kt,
        ...
        (r._jQueryInterface = function (t) {
          return this.each(function () {
            ...
            if (
              ...
              (e || ((e = new r(this, i)), n(this).data(Mt, e)),
              "string" == typeof t)
            ) {
              if (void 0 === e[t])
  ...
  (n.fn[qt] = Gt._jQueryInterface),
    (n.fn[qt].Constructor = Gt),
    ...
    ce = (function () {
      function t(t, e) {
        ...
        (this._element = t),
          ...
          n(this._scrollElement).on(ie.SCROLL, function (t) {
            return i._process(t);
          }),
          this.refresh(),
          this._process();
      ...
      return (
        ...
        (e.dispose = function () {
          n.removeData(this._element, Zt),
            n(this._scrollElement).off($t),
            (this._element = null),
        ...
        (e._getConfig = function (t) {
          if (
            "string" !=
            typeof (t = r({}, ee, "object" == typeof t && t ? t : {})).target
          ) {
        ...
        (e._activate = function (t) {
          ...
          i.hasClass("dropdown-item")
            ? (i.closest(".dropdown").find(".dropdown-toggle").addClass(oe),
              i.addClass(oe))
            : (i.addClass(oe),
              i
                .parents(re)
                .prev(se + ", " + ae)
                .addClass(oe),
              i.parents(re).prev(".nav-item").children(se).addClass(oe)),
            n(this._scrollElement).trigger(ie.ACTIVATE, { relatedTarget: t });
        }),
        (e._clear = function () {
          [].slice
            .call(document.querySelectorAll(this._selector))
  ...
  n(window).on(ie.LOAD_DATA_API, function () {
    ...
    (n.fn[Jt] = ce._jQueryInterface),
    (n.fn[Jt].Constructor = ce),
      ...
      return (
        (e.show = function () {
          ...
          if (
            ...
            var l = n.Event(de.HIDE, { relatedTarget: this._element }),
              c = n.Event(de.SHOW, { relatedTarget: i });
            if (
              (i && n(i).trigger(l),
              ...
              var h = function () {
                var e = n.Event(de.HIDDEN, { relatedTarget: t._element }),
                  o = n.Event(de.SHOWN, { relatedTarget: i });
        ...
        (t._jQueryInterface = function (e) {
          return this.each(function () {
            var i = n(this),
              o = i.data(he);
            if (
              (o || ((o = new t(this)), i.data(he, o)), "string" == typeof e)
            ) {
              if (void 0 === o[e])
                throw new TypeError('No method named "' + e + '"');
              o[e]();
  ...
  n(document).on(
    ...
    (n.fn.tab = pe._jQueryInterface),
    (n.fn.tab.Constructor = pe),
    ...
    we = (function () {
      ...
      return (
        (e.show = function () {
          ...
          var e = function () {
            t._element.classList.remove(be),
        ...
        (e._getConfig = function (t) {
          return (
            ...
            a.typeCheckConfig(ve, t, this.constructor.DefaultType),
            t
          );
        }),
        ...
        (t._jQueryInterface = function (e) {
          return this.each(function () {
            ...
            if (
              (o ||
                ((o = new t(this, "object" == typeof e && e)), i.data(Ee, o)),
              "string" == typeof e)
            ) {
              if (void 0 === o[e])
                throw new TypeError('No method named "' + e + '"');
  ...
  (n.fn[ve] = we._jQueryInterface),
    (n.fn[ve].Constructor = we),
...
!(function (e, t) {
  ...
  function i(e) {
    return (
      (e = r(e, [0, e[0] >>> 1])),
      (e = r((e = t(e, [4283543511, 3981806797])), [0, e[0] >>> 1])),
      r((e = t(e, [3301882366, 444984403])), [0, e[0] >>> 1])
    );
  }
  function o(o, l) {
    l = l || 0;
    for (
      ...
      (f = [
        ...
        (f = n((f = t(f, h)), 31)),
        (d = e((d = n((d = r(d, (f = t(f, m)))), 27)), u)),
        (d = e(t(d, [0, 5]), [0, 1390208809])),
        (g = n((g = t(g, m)), 33)),
        (u = e((u = n((u = r(u, (g = t(g, h)))), 31)), d)),
    ...
    switch (((f = [0, 0]), (g = [0, 0]), s)) {
      ...
      case 9:
        (g = t((g = r(g, [0, o.charCodeAt(p + 8)])), m)),
          (u = r(u, (g = t((g = n(g, 33)), h))));
      case 8:
      ...
      case 1:
        (f = t((f = r(f, [0, o.charCodeAt(p)])), h)),
          (d = r(d, (f = t((f = n(f, 31)), m))));
    }
    return (
      (d = e((d = r(d, [0, o.length])), (u = r(u, [0, o.length])))),
      (u = e(u, d)),
      (d = e((d = i(d)), (u = i(u)))),
      (u = e(u, d)),
            ...
            ? e(
                (function () {
                  ...
                  t.shaderSource(
                    ...
                    (i.offsetUniform = t.getUniformLocation(
                      i,
                      "uniformOffset"
                    )),
                  ...
                  n.push(
                    ...
                    n.push(
                      "webgl max viewport dims:" +
                        e(t.getParameter(t.MAX_VIEWPORT_DIMS))
                    ),
                    ...
                    c &&
                      (n.push(
                        "webgl unmasked vendor:" +
                          t.getParameter(c.UNMASKED_VENDOR_WEBGL)
                      ),
                      n.push(
        ...
        getData: function (e, t) {
          ...
          function i(e) {
            for (var t = !1, a = 0; a < n.length; a++)
              if (
                (t =
                  e[a].offsetWidth !== c[n[a]] || e[a].offsetHeight !== d[n[a]])
              )
                return t;
            return t;
          }
          ...
          for (var f = 0, g = n.length; f < g; f++)
            (c[n[f]] = u[f].offsetWidth), (d[n[f]] = u[f].offsetHeight);
          var h = (function () {
          ...
          o.appendChild(s);
          for (var m = [], p = 0, T = a.length; p < T; p++)
            i(h[a[p]]) && m.push(a[p]);
  ...
  return (
    (c.get = function (e, t) {
      (function (e, t) {
        ...
        (e.components = e.extraComponents.concat(A));
      var n = {
          data: [],
  ...
  return (
      ...
      var u = (l.MD5 = h.extend({
        ...
        _doProcessBlock: function (t, o) {
          ...
          (z = e(z, A, C, D, l, 7, f[0])),
            ...
            (A = e(A, C, D, z, p, 22, f[3])),
            (z = e(z, A, C, D, _, 7, f[4])),
            (D = e(D, z, A, C, v, 12, f[5])),
            ...
            (z = r(z, (A = e(A, C, D, z, H, 22, f[15])), C, D, u, 5, f[16])),
            (D = r(D, z, A, C, y, 9, f[17])),
            (C = r(C, D, z, A, S, 14, f[18])),
            (A = r(A, C, D, z, l, 20, f[19])),
            (z = r(z, A, C, D, v, 5, f[20])),
            (D = r(D, z, A, C, k, 9, f[21])),
            (C = r(C, D, z, A, H, 14, f[22])),
            (A = r(A, C, D, z, _, 20, f[23])),
            (z = r(z, A, C, D, w, 5, f[24])),
            (D = r(D, z, A, C, b, 9, f[25])),
            (C = r(C, D, z, A, p, 14, f[26])),
            (A = r(A, C, D, z, B, 20, f[27])),
            (z = r(z, A, C, D, x, 5, f[28])),
            (D = r(D, z, A, C, d, 9, f[29])),
            (C = r(C, D, z, A, g, 14, f[30])),
            (z = i(z, (A = r(A, C, D, z, m, 20, f[31])), C, D, v, 4, f[32])),
            (D = i(D, z, A, C, B, 11, f[33])),
            (C = i(C, D, z, A, S, 16, f[34])),
            (A = i(A, C, D, z, b, 23, f[35])),
            (z = i(z, A, C, D, u, 4, f[36])),
            (D = i(D, z, A, C, _, 11, f[37])),
            (C = i(C, D, z, A, g, 16, f[38])),
            (A = i(A, C, D, z, k, 23, f[39])),
            (z = i(z, A, C, D, x, 4, f[40])),
            (D = i(D, z, A, C, l, 11, f[41])),
            (C = i(C, D, z, A, p, 16, f[42])),
            (A = i(A, C, D, z, y, 23, f[43])),
            (z = i(z, A, C, D, w, 4, f[44])),
            (D = i(D, z, A, C, m, 11, f[45])),
            (C = i(C, D, z, A, H, 16, f[46])),
            (z = n(z, (A = i(A, C, D, z, d, 23, f[47])), C, D, l, 6, f[48])),
            (D = n(D, z, A, C, g, 10, f[49])),
            (C = n(C, D, z, A, b, 15, f[50])),
            (A = n(A, C, D, z, v, 21, f[51])),
            (z = n(z, A, C, D, m, 6, f[52])),
            (D = n(D, z, A, C, p, 10, f[53])),
            (C = n(C, D, z, A, k, 15, f[54])),
            (A = n(A, C, D, z, u, 21, f[55])),
            (z = n(z, A, C, D, B, 6, f[56])),
            (D = n(D, z, A, C, H, 10, f[57])),
            (C = n(C, D, z, A, y, 15, f[58])),
            (A = n(A, C, D, z, x, 21, f[59])),
            (z = n(z, A, C, D, _, 6, f[60])),
            (D = n(D, z, A, C, S, 10, f[61])),
            (C = n(C, D, z, A, d, 15, f[62])),
            (A = n(A, C, D, z, w, 21, f[63])),
            (h[0] = (h[0] + z) | 0),
            (h[1] = (h[1] + A) | 0),
            (h[2] = (h[2] + C) | 0),
            (h[3] = (h[3] + D) | 0);
      ...
      (i.Utf16 = i.Utf16BE =
        ...
        (i.Utf16LE = {
          stringify: function (e) {
            for (
              var r = e.words, i = e.sigBytes, n = [], o = 0;
              o < i;
              o += 2
            ) {
          ...
          parse: function (e) {
            for (var i = e.length, n = [], o = 0; o < i; o++)
              n[o >>> 1] |= t(e.charCodeAt(o) << (16 - (o % 2) * 16));
        ...
        var e = a,
          ...
          v = ((e.format = {}).OpenSSL = {
            ...
            parse: function (t) {
              ...
              return _.create({ ciphertext: e, salt: i });
            },
          }),
          ...
          g = ((e.kdf = {}).OpenSSL = {
            execute: function (t, e, r, i) {
              i || (i = n.random(8));
              var o = h.create({ keySize: e + r }).compute(t, i),
                s = n.create(o.words.slice(e), 4 * r);
              return (o.sigBytes = 4 * e), _.create({ key: o, iv: s, salt: i });
            },
          }),
    ...
    (a.pad.Iso10126 = {
      pad: function (t, e) {
        var r = 4 * e,
          i = r - (t.sigBytes % r);
        t.concat(a.lib.WordArray.random(i - 1)).concat(
          a.lib.WordArray.create([i << 24], 1)
        );
      },
      unpad: function (t) {
        var e = 255 & t.words[(t.sigBytes - 1) >>> 2];
          ...
          _doReset: function () {
            ...
            for (var n = (this._subKeys = []), o = 0; o < 16; o++) {
              var s = (n[o] = []),
                a = l[o];
              for (r = 0; r < 24; r++)
                (s[(r / 6) | 0] |= e[(h[r] - 1 + a) % 28] << (31 - (r % 6))),
                  (s[4 + ((r / 6) | 0)] |=
                    e[28 + ((h[r + 24] - 1 + a) % 28)] << (31 - (r % 6)));
              s[0] = (s[0] << 1) | (s[0] >>> 31);
    ...
    (function () {
      ...
      var e = a,
        ...
        c = (i.Rabbit = r.extend({
          _doReset: function () {
            for (var e = this._key.words, r = this.cfg.iv, i = 0; i < 4; i++)
              e[i] =
...
!(function (i, s) {
  ...
  var e = "model",
          ...
          for (e = o = 0; e < l.length && !n; )
            if ((n = l[e++].exec(i)))
              for (r = 0; r < w.length; r++)
                (d = n[++o]),
                  "object" == typeof (a = w[r]) && a.length > 0
                    ? 2 == a.length
                      ? "function" == typeof a[1]
                      ...
                      ? "function" != typeof a[1] || (a[1].exec && a[1].test)
                        ? (this[a[0]] = d ? d.replace(a[1], a[2]) : void 0)
                        : (this[a[0]] = d ? a[1].call(this, d, a[2]) : void 0)
                      : 4 == a.length &&
                        (this[a[0]] = d
    ...
    m = function (s, e) {
      if (
        ("object" == typeof s && ((e = s), (s = void 0)), !(this instanceof m))
      )
      ...
      return (
        (this.getBrowser = function () {
          var i = { name: void 0, version: void 0 };
        ...
        (this.getDevice = function () {
          var i = { vendor: void 0, model: void 0, type: void 0 };
  ...
  (m.VERSION = "0.7.20"),
    (m.BROWSER = { NAME: o, MAJOR: "major", VERSION: n }),
    ...
    (m.ENGINE = { NAME: o, VERSION: n }),
    (m.OS = { NAME: o, VERSION: n }),
...
var onRegFrmSubmit = function () {
    $("#registerForm").validate({
      ...
      messages: {
        username: {
          ...
          regex: "Tên đăng nhập từ a-z, 0-9",
        },
        password: {
          required: "Vui lòng nhập mật khẩu",
          minlength: "Mật khẩu tối thiểu 6 ký tự",
          maxlength: "Mật khẩu tối đa 15 ký tự",
          regex: "Mật khẩu không chứa dấu",
        },
      },
      errorElement: "div",
  ...
  onRegFrmSubmitMain = function () {
    $("#registerForm-main").validate({
      rules: {
        username: {
          required: !0,
          normalizer: function (e) {
        ...
        repeat_pwd: { required: !0, equalTo: "#pwd" },
      },
      messages: {
        username: {
          required: "Vui lòng nhập tên đăng nhập",
...
(function () {
  ...
  function L(n) {
    if (kn.test(n)) {
      for (var t = (An.lastIndex = 0); An.test(n); ) ++t;
      n = t;
    } else n = Gn(n);
    return n;
  }
  function U(n) {
    return kn.test(n) ? n.match(An) || [] : n.split("");
  }
  var C,
    D = 1 / 0,
    M = NaN,
  ...
  var zn = {
    ...
    Cn = Ln || Un || Function("return this")(),
    Dn = "object" == typeof exports && exports && !exports.nodeType && exports,
    Mn =
      Dn && "object" == typeof module && module && !module.nodeType && module,
    Tn = Mn && Mn.exports === Dn,
    $n = Tn && Ln.process,
    Fn = (function () {
      try {
        var n = Mn && Mn.f && Mn.f("util").types;
        return n || ($n && $n.binding && $n.binding("util"));
      } catch (n) {}
    })(),
    ...
    Qn = (function x(xn) {
      function jn(n) {
        if (He(n) && !Do(n) && !(n instanceof Ln)) {
          if (n instanceof zn) return n;
          if (Du.call(n, "__wrapped__")) return je(n);
        }
        return new zn(n);
      }
      function An() {}
      ...
      function Gn(n, t) {
        var r,
          ...
          i = !e && !u && To(n),
          o = !e && !u && !i && Zo(n),
          f = (u = (e = e || u || i || o) ? m(n.length, zu) : []).length;
        for (r in n)
          (!t && !Du.call(n, r)) ||
            (e &&
              ("length" == r ||
      ...
      function Xn(n) {
        var t = n.length;
        return t ? n[qt(0, t - 1)] : C;
      }
      function nt(n, t) {
        return de(jr(n), at(t, 0, n.length));
      }
      function tt(n) {
        return de(jr(n));
      }
      function rt(n, t, r) {
        ((r === C || Fe(n[t], r)) && (r !== C || t in n)) || ft(n, t, r);
      }
      function et(n, t, r) {
        var e = n[t];
        (Du.call(n, t) && Fe(e, r) && (r !== C || t in n)) || ft(n, t, r);
      }
      function ut(n, t) {
        for (var r = n.length; r--; ) if (Fe(n[r][0], t)) return r;
        return -1;
      }
      function it(n, t, r, e) {
        return (
      ...
      function ct(n, t) {
        for (var r = -1, e = t.length, u = Au(e), i = null == n; ++r < e; )
          u[r] = i ? C : fu(n, t[r]);
        return u;
      }
      function at(n, t, r) {
        return (
          n == n &&
            (r !== C && (n = n <= r ? n : r), t !== C && (n = n >= t ? n : t)),
          n
        );
      }
      function lt(n, t, e, u, i, o) {
        var f,
          c = 1 & t,
          a = 2 & t,
          l = 4 & t;
        if ((e && (f = i ? e(n, u, i, o) : e(n)), f !== C)) return f;
        if (!Ge(n)) return n;
        if ((u = Do(n))) {
          if (
            ((f = (function (n) {
          ...
          if (
            ...
            f = (function (n, t, r) {
              ...
              switch (t) {
                ...
                case "[object RegExp]":
                  return (
                    ((t = new n.constructor(n.source, sn.exec(n))).lastIndex =
                      n.lastIndex),
                    t
                  );
                case "[object Set]":
                  return new e();
                case "[object Symbol]":
                  return Wi ? Iu(Wi.call(n)) : {};
              }
            })(n, s, c);
          }
        }
        if ((o || (o = new Fn()), (i = o.get(n)))) return i;
        o.set(n, f),
          Po(n)
            ? n.forEach(function (r) {
                f.add(lt(r, t, e, r, n, o));
              })
            : Fo(n) &&
              n.forEach(function (r, u) {
                f.set(u, lt(r, t, e, u, n, o));
              });
        a = l ? (a ? Yr : Jr) : a ? lu : au;
        var p = u ? C : a(n);
        return (
          r(p || n, function (r, u) {
            p && (r = n[(u = r)]), et(f, u, lt(r, t, e, u, n, o));
          }),
          f
        );
      }
      ...
      function pt(n, t, r, e) {
        ...
        r && (t = c(t, A(r))),
          e
            ? ((i = f), (a = !1))
            : 200 <= t.length && ((i = k), (a = !1), (t = new $n(t)));
        n: for (; ++u < l; ) {
          var p = n[u],
            _ = null == r ? p : r(p);
          p = e || 0 !== p ? p : 0;
      ...
      function jt(n, t) {
        for (var r = 0, e = (t = pr(t, n)).length; null != n && r < e; )
          n = n[ye(t[r++])];
        return r && r == e ? n : C;
      }
      function wt(n, t, r) {
        return (t = t(n)), Do(n) ? t : a(t, r(n));
      }
      function mt(n) {
        if (null == n) n = n === C ? "[object Undefined]" : "[object Null]";
        else if (ni && ni in Iu(n)) {
          var t = Du.call(n, ni),
            r = n[ni];
          try {
            n[ni] = C;
      ...
      function St(n, t, r) {
        for (
          ...
          a && t && (p = c(p, A(t))),
            (s = pi(p.length, s)),
            (l[a] =
              !r && (t || (120 <= u && 120 <= p.length)) ? new $n(a && p) : C);
        }
        p = n[0];
        var _ = -1,
          v = l[0];
        n: for (; ++_ < u && h.length < s; ) {
          ...
          if (v ? !k(v, d) : !e(h, d, r)) {
            for (a = i; --a; ) {
              var y = l[a];
              if (y ? !k(y, d) : !e(n[a], d, r)) continue n;
            }
            v && v.push(d), h.push(g);
          }
        }
      ...
      function Ot(t, r, e) {
        return null ==
          (r =
            null == (t = 2 > (r = pr(r, t)).length ? t : jt(t, Qt(r, 0, -1)))
              ? t
              : t[ye(ke(r))])
          ? C
          : n(r, t, e);
      ...
      function It(n) {
        return He(n) && "[object Arguments]" == mt(n);
      }
      function Rt(n, t, r, e, u) {
        if (n === t) t = !0;
        else if (null == n || null == t || (!He(n) && !He(t)))
          t = n != n && t != t;
        else
          n: {
            var i,
              ...
              a =
                "[object Object]" ==
                (i =
                  "[object Arguments]" == (i = f ? "[object Array]" : Vi(n))
                    ? "[object Object]"
                    : i);
            c =
              "[object Object]" ==
              (o =
                "[object Arguments]" == (o = c ? "[object Array]" : Vi(t))
                  ? "[object Object]"
                  : o);
            if ((o = i == o) && To(n)) {
              if (!To(t)) {
            ...
            if (o && !a)
                    ...
                    : (function (n, t, r, e, u, i, o) {
                        switch (r) {
                          ...
                          case "[object Map]":
                            var f = R;
                          case "[object Set]":
                            if ((f || (f = B), n.size != t.size && !(1 & e)))
                              break;
                            return (r = o.get(n))
                              ? r == t
                              : ((e |= 2),
                                o.set(n, t),
                                (t = Gr(f(n), f(t), e, u, i, o)),
                                o.delete(n),
                                t);
                          case "[object Symbol]":
                            if (Wi) return Wi.call(n) == Wi.call(t);
                        }
                        return !1;
                      })(n, t, i, r, e, Rt, u));
            else {
              if (
                !(1 & r) &&
                ((f = a && Du.call(n, "__wrapped__")),
                (i = c && Du.call(t, "__wrapped__")),
                f || i)
              ) {
                (n = f ? n.value() : n),
                  (t = i ? t.value() : t),
                  ...
                  if ((o = u.get(n)) && u.get(t)) t = o == t;
                    ...
                    for (var s = f; ++a < c; ) {
                      var h = n[(l = i[a])],
                        p = t[l];
                      if (e)
                        var _ = f ? e(p, h, l, t, n, u) : e(h, p, l, n, t, u);
                      if (_ === C ? h !== p && !Rt(h, p, r, e, u) : !_) {
                        o = !1;
                        break;
                      }
                      s || (s = "constructor" == l);
      ...
      function zt(n, t, r, e) {
        ...
        for (; ++u < i; ) {
          var c = (f = r[u])[0],
            ...
            l = f[1];
          if (o && f[2]) {
            if (a === C && !(c in n)) return !1;
          } else {
            if (((f = new Fn()), e)) var s = e(a, l, c, n, t, f);
            if (s === C ? !Rt(l, a, 3, e, f) : !s) return !1;
          }
        }
        return !0;
      }
      function Wt(n) {
        return !(!Ge(n) || (Tu && Tu in n)) && (qe(n) ? Pu : _n).test(be(n));
      }
      function Bt(n) {
      ...
      function Lt(n) {
        ...
        var t,
          r = [];
        for (t in Iu(n)) Du.call(n, t) && "constructor" != t && r.push(t);
        return r;
      }
      function Ut(n, t) {
        return n < t;
      ...
      function Mt(n, t) {
        return ae(n) && t == t && !Ge(t)
          ? he(ye(n), t)
          : function (r) {
              var e = fu(r, n);
              return e === C && e === t ? cu(r, n) : Rt(t, e, 3);
            };
      }
                ...
                if ((_ = f.get(a))) rt(n, o, _);
                  ...
                  if (l) {
                    ...
                    s || h || p
                      ...
                      : Ye(a) || Co(a)
                      ? ((_ = c),
                        Co(c) ? (_ = iu(c)) : (Ge(c) && !qe(c)) || (_ = ie(a)))
                      : (l = !1);
                  }
                  l && (f.set(a, _), Tt(_, a, r, e, f), f.delete(a)),
                    rt(n, o, _);
                }
              } else
                (f = e ? e(_e(n, o), i, o + "", n, t, u) : C) === C && (f = i),
                  rt(n, o, f);
            },
            lu
          );
      ...
      function $t(n, t) {
        var r = n.length;
        if (r) return fe((t += 0 > t ? r : 0), r) ? n[t] : C;
      }
      function Ft(n, t, r) {
        var e = -1;
        return (
          (t = c(t.length ? t : [du], A(ne()))),
          (function (n, t) {
            var r = n.length;
      ...
      function Pt(n, t, r, e) {
        var u = e ? g : v,
          ...
          o = t.length,
          f = n;
        for (n === t && (t = jr(t)), r && (f = c(n, A(r))); ++i < o; ) {
          var a = 0,
            l = t[i];
          for (l = r ? r(l) : l; -1 < (a = u(f, l, a, e)); )
            f !== n && Yu.call(f, a, 1), Yu.call(n, a, 1);
        }
        return n;
      }
      function Zt(n, t) {
        for (var r = n ? t.length : 0, e = r - 1; r--; ) {
          ...
          if (r == e || u !== i) {
            var i = u;
            fe(u) ? Yu.call(n, u, 1) : or(n, u);
          }
        }
      }
      function qt(n, t) {
        return n + oi(gi() * (t - n + 1));
      }
      function Vt(n, t) {
        var r = "";
      ...
      function Ht(n, t) {
        var r = hu(n);
        return de(r, at(t, 0, r.length));
      }
      function Jt(n, t, r, e) {
        if (!Ge(n)) return n;
        for (
          var u = -1, i = (t = pr(t, n)).length, o = i - 1, f = n;
          null != f && ++u < i;
      ...
      function er(n) {
        return "number" == typeof n ? n : Xe(n) ? M : +n;
      }
      function ur(n) {
        if ("string" == typeof n) return n;
        if (Do(n)) return c(n, ur) + "";
        if (Xe(n)) return Bi ? Bi.call(n) : "";
        var t = n + "";
      ...
      function or(n, t) {
        return (
          null == (n = 2 > (t = pr(t, n)).length ? n : jt(n, Qt(t, 0, -1))) ||
          delete n[ye(ke(t))]
        );
      }
      function fr(n, t, r, e) {
      ...
      function ar(n, t, r) {
        var e = n.length;
        if (2 > e) return e ? ir(n[0]) : [];
        for (var u = -1, i = Au(e); ++u < e; )
          for (var o = n[u], f = -1; ++f < e; )
            f != u && (i[u] = pt(i[u] || o, n[f], t, r));
        return ir(dt(i, 1), t, r);
      }
      function lr(n, t, r) {
      ...
      function hr(n) {
        return "function" == typeof n ? n : du;
      }
      function pr(n, t) {
        return Do(n) ? n : ae(n, t) ? [n] : Yi(ou(n));
      }
      function _r(n, t, r) {
        var e = n.length;
        return (r = r === C ? e : r), !t && r >= e ? n : Qt(n, t, r);
      }
      function vr(n, t) {
        if (t) return n.slice();
        var r = n.length;
        r = Ku ? Ku(r) : new n.constructor(r);
        return n.copy(r), r;
      }
      function gr(n) {
        var t = new n.constructor(n.byteLength);
        return new Vu(t).set(new Vu(n)), t;
      }
      function dr(n, t) {
        return new n.constructor(
          t ? gr(n.buffer) : n.buffer,
          n.byteOffset,
          n.length
        );
      }
      ...
      function wr(n, t, r, e) {
        ...
        for (var i = -1, o = t.length; ++i < o; ) {
          var f = t[i],
            c = e ? e(r[f], n[f], f, r, n) : C;
          c === C && (c = n[f]), u ? ft(r, f, c) : et(r, f, c);
        }
        return r;
      }
      function mr(n, r) {
      ...
      function Ar(n) {
        return Kt(function (t, r) {
          var e = -1,
            ...
            i = 1 < u ? r[u - 1] : C,
            o = 2 < u ? r[2] : C;
          i = 3 < n.length && "function" == typeof i ? (u--, i) : C;
          for (
            o && ce(r[0], r[1], o) && ((i = 3 > u ? C : i), (u = 1)), t = Iu(t);
            ++e < u;
      ...
      function Er(n, t) {
        return function (r, e) {
          if (null == r) return r;
          if (!Ne(r)) return n(r, e);
          for (
            var u = r.length, i = t ? u : -1, o = Iu(r);
            (t ? i-- : ++i < u) && !1 !== e(o[i], i, o);
      ...
      function kr(n) {
        return function (t, r, e) {
          for (var u = -1, i = Iu(t), o = (e = e(t)).length; o--; ) {
            var f = e[n ? o : ++u];
      ...
      function Sr(n) {
        return function (t) {
          t = ou(t);
          var r = kn.test(t) ? U(t) : C,
            e = r ? r[0] : t.charAt(0);
          return (t = r ? _r(r, 1).join("") : t.slice(1)), e[n]() + t;
        };
      }
      function Or(n) {
        return function (t) {
          return l(vu(_u(t).replace(wn, "")), n, "");
        };
      }
      function Ir(n) {
        return function () {
          ...
          var t,
            r = Li(n.prototype);
          return Ge((t = n.apply(r, t))) ? t : r;
        };
      }
      function Rr(t, r, e) {
        var u = Ir(t);
        return function i() {
          for (var o = arguments.length, f = Au(o), c = o, a = Xr(i); c--; )
            f[c] = arguments[c];
          return (o -= (c =
            3 > o && f[0] !== a && f[o - 1] !== a ? [] : W(f, a)).length) < e
            ? Fr(t, r, Br, i.placeholder, C, f, c, C, C, e - o)
            : n(this && this !== Cn && this instanceof i ? u : t, this, f);
        };
      }
      function zr(n) {
        return function (t, r, e) {
          ...
          return -1 < (r = n(t, r, e)) ? u[i ? t[r] : r] : C;
        };
      }
      function Wr(n) {
        return Hr(function (t) {
          ...
          for (n && t.reverse(); e--; ) {
            ...
            if (u && !i && "wrapper" == Qr(o)) var i = new zn([], !0);
          }
          for (e = i ? e : r; ++e < r; ) {
            var o,
              f = "wrapper" == (u = Qr((o = t[e]))) ? Pi(o) : C;
            i =
              f && le(f[0]) && 424 == f[1] && !f[4].length && 1 == f[9]
                ? i[Qr(f[0])].apply(i, f[3])
                : 1 == o.length && le(o)
                ? i[u]()
                : i.thru(o);
          }
          return function () {
            var n = (u = arguments)[0];
            if (i && 1 == u.length && Do(n)) return i.plant(n).value();
      ...
      function Br(n, t, r, e, u, i, o, f, c, a) {
        var l = 128 & t,
          s = 1 & t,
          h = 2 & t,
          p = 24 & t,
          ...
          v = h ? C : Ir(n);
        return function g() {
          for (var d = arguments.length, y = Au(d), b = d; b--; )
            y[b] = arguments[b];
          if (p) {
            var x,
              j = Xr(g);
          ...
          if (
            ...
            return (
              (j = W(y, j)), Fr(n, t, Br, g.placeholder, r, y, j, f, c, a - d)
            );
          if (((j = s ? r : this), (b = h ? j[n] : n), (d = y.length), f)) {
            x = y.length;
            for (var w = pi(f.length, x), m = jr(y); w--; ) {
              var A = f[w];
              y[w] = fe(A, x) ? m[A] : C;
            }
          ...
          return (
            l && c < d && (y.length = c),
            this && this !== Cn && this instanceof g && (b = v || Ir(b)),
            b.apply(j, y)
          );
        };
      }
      ...
      function Dr(n, t) {
        var r = (t = t === C ? " " : ur(t)).length;
        return 2 > r
          ? r
            ? Vt(t, n)
            : t
          : ((r = Vt(t, ii(n / L(t)))),
            kn.test(t) ? _r(U(r), 0, n).join("") : r.slice(0, n));
      }
      function Mr(t, r, e, u) {
        var i = 1 & r,
          o = Ir(t);
        return function r() {
          for (
            var f = -1,
              ...
              l = u.length,
              s = Au(l + c),
              h = this && this !== Cn && this instanceof r ? o : t;
            ++a < l;
      ...
      function Tr(n) {
        return function (t, r, e) {
          e && "number" != typeof e && ce(t, r, e) && (r = e = C),
            (t = tu(t)),
            r === C ? ((r = t), (t = 0)) : (r = tu(r)),
            (e = e === C ? (t < r ? 1 : -1) : tu(e));
          var u = -1;
          r = hi(ii((r - t) / (e || 1)), 0);
          for (var i = Au(r); r--; ) (i[n ? r : ++u] = t), (t += e);
          return i;
        };
      }
      function $r(n) {
      ...
      function Fr(n, t, r, e, u, i, o, f, c, a) {
        var l = 8 & t;
        return (
      ...
      function Nr(n) {
        var t = Ou[n];
        return function (n, r) {
          if (((n = uu(n)), (r = null == r ? 0 : pi(ru(r), 292)) && ai(n))) {
            var e = (ou(n) + "e").split("e");
            return +(
              (e = (ou((e = t(e[0] + "e" + (+e[1] + r)))) + "e").split(
                "e"
              ))[0] +
              "e" +
              (+e[1] - r)
      ...
      function Zr(n, t, r, e, u, i, o, f) {
        var c = 2 & t;
        if (!c && "function" != typeof n) throw new Wu("Expected a function");
        var a = e ? e.length : 0;
        if (
          (a || ((t &= -97), (e = u = C)),
          (o = o === C ? o : hi(ru(o), 0)),
        ...
        return (
          ...
          h &&
            ...
            (r = h[3]) &&
              ((e = i[3]),
              (i[3] = e ? br(e, r, h[4]) : r),
              (i[4] = e ? W(i[3], "__lodash_placeholder__") : h[4])),
            (r = h[5]) &&
              ((e = i[5]),
              (i[5] = e ? xr(e, r, h[6]) : r),
              (i[6] = e ? W(i[5], "__lodash_placeholder__") : h[6])),
            (r = h[7]) && (i[7] = r),
            128 & n && (i[8] = null == i[8] ? h[8] : pi(i[8], h[8])),
            null == i[9] && (i[9] = h[9]),
            (i[0] = h[0]),
            (i[1] = t)),
          (n = i[0]),
          ...
          (e = i[3]),
          (u = i[4]),
          !(f = i[9] = i[9] === C ? (c ? 0 : n.length) : hi(i[9] - a, 0)) &&
            24 & t &&
            (t &= -25),
          ve(
            (h ? Ti : Gi)(
              t && 1 != t
                ...
                : (function (n, t, r) {
                    ...
                    return function t() {
                      return (
                        this && this !== Cn && this instanceof t ? u : n
      ...
      function qr(n, t, r, e) {
        return n === C || (Fe(n, Lu[r]) && !Du.call(e, r)) ? t : n;
      }
      function Vr(n, t, r, e, u, i) {
        return (
          Ge(n) && Ge(t) && (i.set(t, n), Tt(n, t, C, Vr, i), i.delete(t)), n
        );
      }
      function Kr(n) {
        return Ye(n) ? C : n;
      }
      function Gr(n, t, r, e, u, i) {
        var o = 1 & r,
          f = n.length;
        ...
        for (i.set(n, t), i.set(t, n); ++c < f; ) {
          ...
          if (l) {
            if (
              !h(t, function (n, t) {
                if (!k(l, t) && (s === n || u(s, n, r, e, i))) return l.push(t);
              })
            ) {
              a = !1;
              break;
      ...
      function Qr(n) {
        for (
          var t = n.name + "", r = Ei[t], e = Du.call(Ei, t) ? r.length : 0;
          e--;
      ...
      function Xr(n) {
        return (Du.call(jn, "placeholder") ? jn : n).placeholder;
      }
      function ne() {
        var n = (n = jn.iteratee || yu) === yu ? Bt : n;
      ...
      function ue(n, t, r) {
        for (var e = -1, u = (t = pr(t, n)).length, i = !1; ++e < u; ) {
          var o = ye(t[e]);
      ...
      function ie(n) {
        return "function" != typeof n.constructor || se(n) ? {} : Li(Gu(n));
      }
      function oe(n) {
        return Do(n) || Co(n) || !!(Qu && n && n[Qu]);
      }
      function fe(n, t) {
        var r = typeof n;
        return (
      ...
      function se(n) {
        ...
        return n === (("function" == typeof t && t.prototype) || Lu);
      }
      function he(n, t) {
        return function (r) {
          return null != r && r[n] === t && (t !== C || n in Iu(r));
        };
      }
      function pe(t, r, e) {
        return (
          (r = hi(r === C ? t.length - 1 : r, 0)),
          function () {
            for (
              var u = arguments, i = -1, o = hi(u.length - r, 0), f = Au(o);
              ++i < o;

            )
              f[i] = u[r + i];
            for (i = -1, o = Au(r + 1); ++i < r; ) o[i] = u[i];
      ...
      function ve(n, t, r) {
        ...
        var u,
          i = xe;
        return (
          (r = i((u = (u = e.match(on)) ? u[1].split(fn) : []), r)),
          (i = r.length) &&
            ((r[(u = i - 1)] = (1 < i ? "& " : "") + r[u]),
            (r = r.join(2 < i ? ", " : " ")),
            (e = e.replace(un, "{\n/* [wrapped with " + r + "] */\n"))),
      ...
      function ye(n) {
        if ("string" == typeof n || Xe(n)) return n;
        var t = n + "";
        return "0" == t && 1 / n == -D ? "-0" : t;
      }
      function be(n) {
      ...
      function je(n) {
        ...
        return (
          (t.__actions__ = jr(n.__actions__)),
      ...
      function me(n, t, r) {
        ...
        var u = e - 1;
        return (
          r !== C && ((u = ru(r)), (u = 0 > r ? hi(e + u, 0) : pi(u, e - 1))),
          _(n, ne(t, 3), u, !0)
        );
      }
      function Ae(n) {
      ...
      function Ie(n) {
        ...
        return (
          (n = i(n, function (n) {
            if (Pe(n)) return (t = hi(n.length, t)), !0;
          })),
          m(t, function (t) {
            return c(n, b(t));
          })
      ...
      function ze(n) {
        return ((n = jn(n)).__chain__ = !0), n;
      }
      function We(n, t) {
        return t(n);
      }
      function Be(n, t) {
        return (Do(n) ? r : Ui)(n, ne(t, 3));
      }
      function Le(n, t) {
        return (Do(n) ? e : Ci)(n, ne(t, 3));
      }
      function Ue(n, t) {
        return (Do(n) ? c : Ct)(n, ne(t, 3));
      }
      function Ce(n, t, r) {
        return (
          (t = r ? C : t),
      ...
      function De(n, t) {
        ...
        return (
          ...
          function () {
            return (
              0 < --n && (r = t.apply(this, arguments)), 1 >= n && (t = C), r
            );
          }
        );
      }
      function Me(n, t, r) {
        function e(t) {
          var r = c,
            e = a;
          return (c = a = C), (_ = t), (s = n.apply(e, r));
        }
        function u(n) {
          var r = n - p;
          return (n -= _), p === C || r >= t || 0 > r || (g && n >= l);
        }
        function i() {
          var n = Eo();
          if (u(n)) return o(n);
        ...
        function o(n) {
          return (h = C), d && c ? e(n) : ((c = a = C), s);
        }
        function f() {
          var n = Eo(),
            r = u(n);
          if (((c = arguments), (a = this), (p = n), r)) {
            if (h === C) return (_ = n = p), (h = Hi(i, t)), v ? e(n) : s;
            if (g) return Fi(h), (h = Hi(i, t)), e(p);
          }
          return h === C && (h = Hi(i, t)), s;
        }
        var c,
          a,
          l,
        ...
        return (
          ...
          Ge(r) &&
            ((v = !!r.leading),
            (l = (g = "maxWait" in r) ? hi(uu(r.maxWait) || 0, t) : l),
            (d = "trailing" in r ? !!r.trailing : d)),
          (f.cancel = function () {
            h !== C && Fi(h), (_ = 0), (c = p = a = h = C);
          }),
          (f.flush = function () {
            return h === C ? s : o(Eo());
          }),
      ...
      function Te(n, t) {
        ...
        if ("function" != typeof n || (null != t && "function" != typeof t))
          throw new Wu("Expected a function");
        return (r.cache = new (Te.Cache || Mn)()), r;
      }
      function $e(n) {
        if ("function" != typeof n) throw new Wu("Expected a function");
        return function () {
      ...
      function Ne(n) {
        return null != n && Ke(n.length) && !qe(n);
      }
      function Pe(n) {
        return He(n) && Ne(n);
      }
      function Ze(n) {
        ...
        return (
          ...
          ("string" == typeof n.message && "string" == typeof n.name && !Ye(n))
        );
      }
      function qe(n) {
        return (
          !!Ge(n) &&
          ("[object Function]" == (n = mt(n)) ||
      ...
      function Ke(n) {
        return (
          "number" == typeof n && -1 < n && 0 == n % 1 && 9007199254740991 >= n
        );
      }
      function Ge(n) {
        var t = typeof n;
      ...
      function Je(n) {
        return "number" == typeof n || (He(n) && "[object Number]" == mt(n));
      }
      function Ye(n) {
        return (
          !(!He(n) || "[object Object]" != mt(n)) &&
          (null === (n = Gu(n)) ||
            ("function" ==
              typeof (n = Du.call(n, "constructor") && n.constructor) &&
              n instanceof n &&
              Cu.call(n) == Fu))
        );
      }
      function Qe(n) {
        return (
          "string" == typeof n ||
          (!Do(n) && He(n) && "[object String]" == mt(n))
        );
      }
      function Xe(n) {
        return "symbol" == typeof n || (He(n) && "[object Symbol]" == mt(n));
      }
      function nu(n) {
        if (!n) return [];
        if (Ne(n)) return Qe(n) ? U(n) : jr(n);
        if (Xu && n[Xu]) {
          n = n[Xu]();
        ...
        return (
          "[object Map]" == (t = Vi(n)) ? R : "[object Set]" == t ? B : hu
        )(n);
      }
      function tu(n) {
        return n
      ...
      function eu(n) {
        return n ? at(ru(n), 0, 4294967295) : 0;
      }
      function uu(n) {
        ...
        if (
          (Ge(n) &&
            (n = Ge((n = "function" == typeof n.valueOf ? n.valueOf() : n))
              ? n + ""
              : n),
          "string" != typeof n)
        )
      ...
      function fu(n, t, r) {
        return (n = null == n ? C : jt(n, t)) === C ? r : n;
      }
      function cu(n, t) {
        return null != n && ue(n, t, kt);
      }
      function au(n) {
        return Ne(n) ? Gn(n) : Lt(n);
      }
      function lu(n) {
        if (Ne(n)) n = Gn(n, !0);
        else if (Ge(n)) {
          var t,
            ...
            e = [];
          for (t in n)
            ("constructor" != t || (!r && Du.call(n, t))) && e.push(t);
          n = e;
        } else {
          if (((t = []), null != n)) for (r in Iu(n)) t.push(r);
          n = t;
        }
        return n;
      }
      ...
      function hu(n) {
        return null == n ? [] : E(n, au(n));
      }
      function pu(n) {
        return df(ou(n).toLowerCase());
      }
      function _u(n) {
        return (n = ou(n)) && n.replace(dn, Hn).replace(mn, "");
      }
      function vu(n, t, r) {
        return (
          (n = ou(n)),
      ...
      function bu(n, t, e) {
        var u = au(t),
          i = xt(t, u);
        null != e ||
          (Ge(t) && (i.length || !u.length)) ||
          ((e = t), (t = n), (n = this), (i = xt(t, au(t))));
        var o = !(Ge(e) && "chain" in e && !e.chain),
          f = qe(n);
        return (
          r(i, function (r) {
            var e = t[r];
              ...
              f &&
                (n.prototype[r] = function () {
                  ...
                  if (o || t) {
                    ...
                    return (
                      (r.__actions__ = jr(this.__actions__)).push({
                        func: e,
                        args: arguments,
                        thisArg: n,
                      }),
      ...
      var Au = (xn =
          null == xn ? Cn : Qn.defaults(Cn.Object(), xn, Qn.pick(Cn, On)))
          .Array,
        Eu = xn.Date,
        ku = xn.Error,
        Su = xn.Function,
        ...
        Bu = Au.prototype,
        Lu = Iu.prototype,
        Uu = xn["__core-js_shared__"],
        Cu = Su.prototype.toString,
        Du = Lu.hasOwnProperty,
        Mu = 0,
        Tu = (function () {
          var n = /[^.]+$/.exec((Uu && Uu.keys && Uu.keys.IE_PROTO) || "");
        ...
        Vu = xn.Uint8Array,
        Ku = Zu ? Zu.g : C,
        Gu = z(Iu.getPrototypeOf, Iu),
        Hu = Iu.create,
        Ju = Lu.propertyIsEnumerable,
        Yu = Bu.splice,
        Qu = qu ? qu.isConcatSpreadable : C,
        Xu = qu ? qu.iterator : C,
        ni = qu ? qu.toStringTag : C,
        ti = (function () {
          try {
            var n = ee(Iu, "defineProperty");
            return n({}, "", {}), n;
          } catch (n) {}
        })(),
        ri = xn.clearTimeout !== Cn.clearTimeout && xn.clearTimeout,
        ei = Eu && Eu.now !== Cn.Date.now && Eu.now,
        ui = xn.setTimeout !== Cn.setTimeout && xn.setTimeout,
        ii = Ou.ceil,
        oi = Ou.floor,
        fi = Iu.getOwnPropertySymbols,
        ci = Zu ? Zu.isBuffer : C,
        ai = xn.isFinite,
        li = Bu.join,
        si = z(Iu.keys, Iu),
        ...
        Li = (function () {
          ...
          return function (t) {
            return Ge(t)
              ? Hu
                ? Hu(t)
                : ((n.prototype = t), (t = new n()), (n.prototype = C), t)
              : {};
          };
        })();
      (jn.templateSettings = {
        ...
        (jn.prototype = An.prototype),
        (jn.prototype.constructor = jn),
        (zn.prototype = Li(An.prototype)),
        (zn.prototype.constructor = zn),
        (Ln.prototype = Li(An.prototype)),
        ...
        (Un.prototype.has = function (n) {
          var t = this.__data__;
          return mi ? t[n] !== C : Du.call(t, n);
        }),
        (Un.prototype.set = function (n, t) {
          var r = this.__data__;
          return (
            (this.size += this.has(n) ? 0 : 1),
            (r[n] = mi && t === C ? "__lodash_hash_undefined__" : t),
            this
          );
        }),
        ...
        (Dn.prototype.delete = function (n) {
          ...
          return !(
            0 > (n = ut(t, n)) ||
            (n == t.length - 1 ? t.pop() : Yu.call(t, n, 1), --this.size, 0)
          );
        }),
        (Dn.prototype.get = function (n) {
          var t = this.__data__;
          return 0 > (n = ut(t, n)) ? C : t[n][1];
        }),
        ...
        (Mn.prototype.delete = function (n) {
          return (n = te(this, n).delete(n)), (this.size -= n ? 1 : 0), n;
        }),
        (Mn.prototype.get = function (n) {
          return te(this, n).get(n);
        }),
        (Mn.prototype.has = function (n) {
          return te(this, n).has(n);
        }),
      ...
      var Ui = Er(yt),
        ...
        qi = fi
          ? function (n) {
              for (var t = []; n; ) a(t, Zi(n)), (n = Gu(n));
              return t;
            }
          : wu,
        Vi = mt;
      ((yi && "[object DataView]" != Vi(new yi(new ArrayBuffer(1)))) ||
        (bi && "[object Map]" != Vi(new bi())) ||
        (xi && "[object Promise]" != Vi(xi.resolve())) ||
        (ji && "[object Set]" != Vi(new ji())) ||
        (wi && "[object WeakMap]" != Vi(new wi()))) &&
        (Vi = function (n) {
          var t = mt(n);
          if (
            (n = (n = "[object Object]" == t ? n.constructor : C) ? be(n) : "")
          )
            switch (n) {
              case ki:
      ...
      var Ki = Uu ? qe : mu,
        ...
        Qi = Kt(function (n, t) {
          return Pe(n) ? pt(n, dt(t, 1, Pe, !0)) : [];
        }),
        Xi = Kt(function (n, t) {
          var r = ke(t);
          return (
            Pe(r) && (r = C), Pe(n) ? pt(n, dt(t, 1, Pe, !0), ne(r, 2)) : []
          );
        }),
        no = Kt(function (n, t) {
          var r = ke(t);
          return Pe(r) && (r = C), Pe(n) ? pt(n, dt(t, 1, Pe, !0), C, r) : [];
        }),
        to = Kt(function (n) {
          var t = c(n, sr);
        ...
        eo = Kt(function (n) {
          var t = ke(n),
            r = c(n, sr);
          return (
            (t = "function" == typeof t ? t : C) && r.pop(),
            r.length && r[0] === n[0] ? St(r, C, t) : []
          );
        }),
        uo = Kt(Se),
        io = Hr(function (n, t) {
        ...
        oo = Kt(function (n) {
          return ir(dt(n, 1, Pe, !0));
        }),
        fo = Kt(function (n) {
          var t = ke(n);
          return Pe(t) && (t = C), ir(dt(n, 1, Pe, !0), ne(t, 2));
        }),
        co = Kt(function (n) {
          var t = "function" == typeof (t = ke(n)) ? t : C;
          return ir(dt(n, 1, Pe, !0), C, t);
        }),
        ao = Kt(function (n, t) {
          return Pe(n) ? pt(n, t) : [];
        }),
        ...
        so = Kt(function (n) {
          var t = ke(n);
          return Pe(t) && (t = C), ar(i(n, Pe), ne(t, 2));
        }),
        ho = Kt(function (n) {
          var t = "function" == typeof (t = ke(n)) ? t : C;
          return ar(i(n, Pe), C, t);
        }),
        po = Kt(Ie),
        _o = Kt(function (n) {
          var t =
            "function" == typeof (t = 1 < (t = n.length) ? n[t - 1] : C)
              ? (n.pop(), t)
              : C;
          return Re(n, t);
        }),
        vo = Hr(function (n) {
          ...
          var r = n.length,
            e = r ? n[0] : 0,
            u = this.__wrapped__;
          return !(1 < r || this.__actions__.length) && u instanceof Ln && fe(e)
            ? ((u = u.slice(e, +e + (r ? 1 : 0))).__actions__.push({
              ...
              new zn(u, this.__chain__).thru(function (n) {
                return r && !n.length && n.push(C), n;
              }))
            : this.thru(t);
        }),
        go = mr(function (n, t, r) {
          Du.call(n, r) ? ++n[r] : ft(n, r, 1);
        }),
        yo = zr(we),
        bo = zr(me),
        xo = mr(function (n, t, r) {
          Du.call(n, r) ? n[r].push(t) : ft(n, r, [t]);
        }),
        jo = Kt(function (t, r, e) {
          var u = -1,
            i = "function" == typeof r,
            o = Ne(t) ? Au(t.length) : [];
          return (
            Ui(t, function (t) {
              o[++u] = i ? n(r, t, e) : Ot(t, r, e);
            }),
            o
          );
        }),
        wo = mr(function (n, t, r) {
          ft(n, r, t);
        }),
        mo = mr(
          function (n, t, r) {
        ...
        Io = Kt(function (n, t, r) {
          return ht(n, uu(t) || 0, r);
        });
      Te.Cache = Mn;
      var Ro = Kt(function (t, r) {
          var e = (r =
            1 == r.length && Do(r[0]) ? c(r[0], A(ne())) : c(dt(r, 1), A(ne())))
            .length;
          return Kt(function (u) {
            for (var i = -1, o = pi(u.length, e); ++i < o; )
              u[i] = r[i].call(this, u[i]);
            return n(t, this, u);
          });
        }),
        zo = Kt(function (n, t) {
          return Zr(n, 32, C, t, W(t, Xr(zo)));
        }),
        Wo = Kt(function (n, t) {
          return Zr(n, 64, C, t, W(t, Xr(Wo)));
        }),
        Bo = Hr(function (n, t) {
          return Zr(n, 256, C, C, C, t);
        }),
        Lo = $r(At),
        Uo = $r(function (n, t) {
          return n >= t;
        ...
        Co = It(
          ...
          ? It
          : function (n) {
              return He(n) && Du.call(n, "callee") && !Ju.call(n, "callee");
            },
        Do = Au.isArray,
        Mo = Nn
          ? A(Nn)
          : function (n) {
              return He(n) && "[object ArrayBuffer]" == mt(n);
            },
        To = ci || mu,
        $o = Pn
          ? A(Pn)
          : function (n) {
              return He(n) && "[object Date]" == mt(n);
            },
        Fo = Zn
          ? A(Zn)
          : function (n) {
              return He(n) && "[object Map]" == Vi(n);
            },
        No = qn
          ? A(qn)
          : function (n) {
              return He(n) && "[object RegExp]" == mt(n);
            },
        Po = Vn
          ? A(Vn)
          : function (n) {
              return He(n) && "[object Set]" == Vi(n);
            },
        Zo = Kn
          ? A(Kn)
          : function (n) {
              return He(n) && Ke(n.length) && !!In[mt(n)];
            },
        qo = $r(Ut),
        Vo = $r(function (n, t) {
          return n <= t;
        ...
        Ko = Ar(function (n, t) {
          if (se(t) || Ne(t)) wr(t, au(t), n);
          else for (var r in t) Du.call(t, r) && et(n, r, t[r]);
        }),
        Go = Ar(function (n, t) {
          wr(t, lu(t), n);
        }),
        Ho = Ar(function (n, t, r, e) {
          wr(t, lu(t), n, e);
        }),
        Jo = Ar(function (n, t, r, e) {
          wr(t, au(t), n, e);
        }),
        Yo = Hr(ct),
        Qo = Kt(function (n, t) {
          ...
          var r = -1,
            e = t.length;
          for (
            (u = 2 < e ? t[2] : C) && ce(t[0], t[1], u) && (e = 1);
            ++r < e;

          )
            for (var u, i = lu((u = t[r])), o = -1, f = i.length; ++o < f; ) {
              var c = i[o],
                a = n[c];
              (a === C || (Fe(a, Lu[c]) && !Du.call(n, c))) && (n[c] = u[c]);
            }
          return n;
        }),
        Xo = Kt(function (t) {
          return t.push(C, Vr), n(uf, C, t);
        }),
        nf = Lr(function (n, t, r) {
          null != t && "function" != typeof t.toString && (t = $u.call(t)),
            (n[t] = r);
        }, gu(du)),
        tf = Lr(function (n, t, r) {
          null != t && "function" != typeof t.toString && (t = $u.call(t)),
            Du.call(n, t) ? n[t].push(r) : (n[t] = [r]);
        }, ne),
        rf = Kt(Ot),
        ef = Ar(function (n, t, r) {
          Tt(n, t, r);
        }),
        uf = Ar(function (n, t, r, e) {
          Tt(n, t, r, e);
        }),
        of = Hr(function (n, t) {
          var r = {};
          ...
          var e = !1;
          (t = c(t, function (t) {
            return (t = pr(t, n)), e || (e = 1 < t.length), t;
          })),
            wr(n, Yr(n), r),
            e && (r = lt(r, 7, Kr));
          for (var u = t.length; u--; ) or(r, t[u]);
          return r;
        }),
        ff = Hr(function (n, t) {
          return null == n
        ...
        cf = Pr(au),
        af = Pr(lu),
        lf = Or(function (n, t, r) {
          return (t = t.toLowerCase()), n + (r ? pu(t) : t);
        }),
        sf = Or(function (n, t, r) {
          return n + (r ? "-" : "") + t.toLowerCase();
        }),
        hf = Or(function (n, t, r) {
          return n + (r ? " " : "") + t.toLowerCase();
        }),
        pf = Sr("toLowerCase"),
        _f = Or(function (n, t, r) {
          return n + (r ? "_" : "") + t.toLowerCase();
        }),
        vf = Or(function (n, t, r) {
          return n + (r ? " " : "") + df(t);
        }),
        gf = Or(function (n, t, r) {
        ...
        yf = Kt(function (t, r) {
          try {
            ...
            return Ze(n) ? n : new ku(n);
          }
        }),
        bf = Hr(function (n, t) {
          return (
            r(t, function (t) {
              (t = ye(t)), ft(n, t, ko(n[t], n));
            }),
            n
          );
        }),
      ...
      return (
        ...
        (jn.chain = ze),
        (jn.chunk = function (n, t, r) {
          if (
            ((t = (r ? ce(n, t, r) : t === C) ? 1 : hi(ru(t), 0)),
            !(r = null == n ? 0 : n.length) || 1 > t)
          )
            return [];
          for (var e = 0, u = 0, i = Au(ii(r / t)); e < r; )
            i[u++] = Qt(n, e, (e += t));
          return i;
        }),
        ...
        (jn.concat = function () {
          ...
          if (!n) return [];
          for (var t = Au(n - 1), r = arguments[0]; n--; )
            t[n - 1] = arguments[n];
          return a(Do(r) ? jr(r) : [r], dt(t, 1));
        }),
        (jn.cond = function (t) {
        ...
        (jn.constant = gu),
        (jn.countBy = go),
        (jn.create = function (n, t) {
          var r = Li(n);
          return null == t ? r : ot(r, t);
        }),
        (jn.curry = function n(t, r, e) {
          return (
            ((t = Zr(t, 8, C, C, C, C, C, (r = e ? C : r))).placeholder =
              n.placeholder),
            t
          );
        }),
        (jn.curryRight = function n(t, r, e) {
          return (
            ((t = Zr(t, 16, C, C, C, C, C, (r = e ? C : r))).placeholder =
              n.placeholder),
            t
          );
        }),
        ...
        (jn.difference = Qi),
        (jn.differenceBy = Xi),
        (jn.differenceWith = no),
        (jn.drop = function (n, t, r) {
          var e = null == n ? 0 : n.length;
          return e ? Qt(n, 0 > (t = r || t === C ? 1 : ru(t)) ? 0 : t, e) : [];
        }),
        (jn.dropRight = function (n, t, r) {
          var e = null == n ? 0 : n.length;
          return e
            ? Qt(n, 0, 0 > (t = e - (t = r || t === C ? 1 : ru(t))) ? 0 : t)
            : [];
        }),
        (jn.dropRightWhile = function (n, t) {
          return n && n.length ? fr(n, ne(t, 3), !0, !0) : [];
        }),
        (jn.dropWhile = function (n, t) {
          return n && n.length ? fr(n, ne(t, 3), !0) : [];
        }),
        (jn.fill = function (n, t, r, e) {
          var u = null == n ? 0 : n.length;
          if (!u) return [];
          for (
            r && "number" != typeof r && ce(n, t, r) && ((r = 0), (e = u)),
              u = n.length,
              0 > (r = ru(r)) && (r = -r > u ? 0 : u + r),
              0 > (e = e === C || e > u ? u : ru(e)) && (e += u),
              e = r > e ? 0 : eu(e);
            r < e;
        ...
        (jn.flatMapDepth = function (n, t, r) {
          return (r = r === C ? 1 : ru(r)), dt(Ue(n, t), r);
        }),
        (jn.flatten = Ae),
        (jn.flattenDeep = function (n) {
          return null != n && n.length ? dt(n, D) : [];
        }),
        (jn.flattenDepth = function (n, t) {
          return null != n && n.length ? dt(n, (t = t === C ? 1 : ru(t))) : [];
        }),
        (jn.flip = function (n) {
          return Zr(n, 512);
        }),
        ...
        (jn.functions = function (n) {
          return null == n ? [] : xt(n, au(n));
        }),
        (jn.functionsIn = function (n) {
          return null == n ? [] : xt(n, lu(n));
        }),
        (jn.groupBy = xo),
        (jn.initial = function (n) {
          return null != n && n.length ? Qt(n, 0, -1) : [];
        }),
        (jn.intersection = to),
        (jn.intersectionBy = ro),
        (jn.intersectionWith = eo),
        (jn.invert = nf),
        (jn.invertBy = tf),
        (jn.invokeMap = jo),
        (jn.iteratee = yu),
        ...
        (jn.pickBy = su),
        (jn.property = ju),
        (jn.propertyOf = function (n) {
          return function (t) {
            return null == n ? C : jt(n, t);
          };
        }),
        (jn.pull = uo),
        (jn.pullAll = Se),
        (jn.pullAllBy = function (n, t, r) {
          return n && n.length && t && t.length ? Pt(n, t, ne(r, 2)) : n;
        }),
        (jn.pullAllWith = function (n, t, r) {
          return n && n.length && t && t.length ? Pt(n, t, C, r) : n;
        }),
        (jn.pullAt = io),
        (jn.range = Sf),
        (jn.rangeRight = Of),
        ...
        (jn.rest = function (n, t) {
          if ("function" != typeof n) throw new Wu("Expected a function");
          return Kt(n, (t = t === C ? t : ru(t)));
        }),
        (jn.reverse = Oe),
        (jn.sampleSize = function (n, t, r) {
          return (
            (t = (r ? ce(n, t, r) : t === C) ? 1 : ru(t)),
            (Do(n) ? nt : Ht)(n, t)
          );
        }),
        (jn.set = function (n, t, r) {
          return null == n ? n : Jt(n, t, r);
        }),
        (jn.setWith = function (n, t, r, e) {
          return (
            (e = "function" == typeof e ? e : C), null == n ? n : Jt(n, t, r, e)
          );
        }),
        ...
        (jn.slice = function (n, t, r) {
          var e = null == n ? 0 : n.length;
          return e
            ? (r && "number" != typeof r && ce(n, t, r)
                ? ((t = 0), (r = e))
                : ((t = null == t ? 0 : ru(t)), (r = r === C ? e : ru(r))),
              Qt(n, t, r))
            : [];
        }),
        (jn.sortBy = Ao),
        (jn.sortedUniq = function (n) {
          return n && n.length ? rr(n) : [];
        }),
        (jn.sortedUniqBy = function (n, t) {
          return n && n.length ? rr(n, ne(t, 2)) : [];
        }),
        (jn.split = function (n, t, r) {
          return (
            r && "number" != typeof r && ce(n, t, r) && (t = r = C),
            (r = r === C ? 4294967295 : r >>> 0)
              ? (n = ou(n)) &&
        ...
        (jn.spread = function (t, r) {
          if ("function" != typeof t) throw new Wu("Expected a function");
          return (
            (r = null == r ? 0 : hi(ru(r), 0)),
            Kt(function (e) {
              var u = e[r];
              return (e = _r(e, 0, r)), u && a(e, u), n(t, this, e);
            })
          );
        }),
        (jn.tail = function (n) {
        ...
        (jn.take = function (n, t, r) {
          return n && n.length
            ? Qt(n, 0, 0 > (t = r || t === C ? 1 : ru(t)) ? 0 : t)
            : [];
        }),
        (jn.takeRight = function (n, t, r) {
          var e = null == n ? 0 : n.length;
          return e
            ? Qt(n, 0 > (t = e - (t = r || t === C ? 1 : ru(t))) ? 0 : t, e)
            : [];
        }),
        (jn.takeRightWhile = function (n, t) {
          return n && n.length ? fr(n, ne(t, 3), !1, !0) : [];
        }),
        (jn.takeWhile = function (n, t) {
          return n && n.length ? fr(n, ne(t, 3)) : [];
        }),
        (jn.tap = function (n, t) {
          return t(n), n;
        }),
        (jn.throttle = function (n, t, r) {
          ...
          return (
            ...
            Me(n, t, { leading: e, maxWait: t, trailing: u })
          );
        }),
        (jn.thru = We),
        (jn.toArray = nu),
        (jn.toPairs = cf),
        (jn.toPairsIn = af),
        (jn.toPath = function (n) {
          return Do(n) ? c(n, ye) : Xe(n) ? [n] : jr(Yi(ou(n)));
        }),
        (jn.toPlainObject = iu),
        (jn.transform = function (n, t, e) {
          var u = Do(n),
            i = u || To(n) || Zo(n);
          if (((t = ne(t, 4)), null == e)) {
            var o = n && n.constructor;
            e = i ? (u ? new o() : []) : Ge(n) && qe(o) ? Li(Gu(n)) : {};
          }
          return (
            (i ? r : yt)(n, function (n, r, u) {
              return t(e, n, r, u);
            }),
            e
          );
        ...
        (jn.unzip = Ie),
        (jn.unzipWith = Re),
        (jn.update = function (n, t, r) {
          return null == n ? n : Jt(n, t, hr(r)(jt(n, t)), void 0);
        }),
        (jn.updateWith = function (n, t, r, e) {
          return (
            (e = "function" == typeof e ? e : C),
            null != n && (n = Jt(n, t, hr(r)(jt(n, t)), e)),
            n
          );
        }),
        (jn.values = hu),
        (jn.valuesIn = function (n) {
          return null == n ? [] : E(n, lu(n));
        }),
        (jn.without = ao),
        (jn.words = vu),
        (jn.wrap = function (n, t) {
          return zo(hr(t), n);
        }),
        (jn.xor = lo),
        (jn.xorBy = so),
        ...
        (jn.cloneDeepWith = function (n, t) {
          return lt(n, 5, (t = "function" == typeof t ? t : C));
        }),
        (jn.cloneWith = function (n, t) {
          return lt(n, 4, (t = "function" == typeof t ? t : C));
        }),
        (jn.conformsTo = function (n, t) {
          return null == t || st(n, t, au(t));
        }),
        (jn.deburr = _u),
        (jn.defaultTo = function (n, t) {
          return null == n || n != n ? t : n;
        }),
        (jn.divide = zf),
        (jn.endsWith = function (n, t, r) {
          (n = ou(n)), (t = ur(t));
          var e = n.length;
          e = r = r === C ? e : at(ru(r), 0, e);
          return 0 <= (r -= t.length) && n.slice(r, e) == t;
        }),
        (jn.eq = Fe),
        (jn.escape = function (n) {
          return (n = ou(n)) && V.test(n) ? n.replace(Z, Jn) : n;
        }),
        (jn.escapeRegExp = function (n) {
          return (n = ou(n)) && nn.test(n) ? n.replace(X, "\\$&") : n;
        }),
        (jn.every = function (n, t, r) {
          var e = Do(n) ? u : _t;
          return r && ce(n, t, r) && (t = C), e(n, ne(t, 3));
        }),
        (jn.find = yo),
        (jn.findIndex = we),
        (jn.findKey = function (n, t) {
          return p(n, ne(t, 3), yt);
        }),
        (jn.findLast = bo),
        (jn.findLastIndex = me),
        (jn.findLastKey = function (n, t) {
          return p(n, ne(t, 3), bt);
        }),
        (jn.floor = Wf),
        (jn.forEach = Be),
        (jn.forEachRight = Le),
        (jn.forIn = function (n, t) {
          return null == n ? n : Di(n, ne(t, 3), lu);
        }),
        (jn.forInRight = function (n, t) {
          return null == n ? n : Mi(n, ne(t, 3), lu);
        }),
        (jn.forOwn = function (n, t) {
          return n && yt(n, ne(t, 3));
        }),
        (jn.forOwnRight = function (n, t) {
          return n && bt(n, ne(t, 3));
        }),
        (jn.get = fu),
        (jn.gt = Lo),
        (jn.gte = Uo),
        (jn.has = function (n, t) {
          return null != n && ue(n, t, Et);
        }),
        (jn.hasIn = cu),
        (jn.head = Ee),
        (jn.identity = du),
        (jn.includes = function (n, t, r, e) {
          return (
            (n = Ne(n) ? n : hu(n)),
            (r = r && !e ? ru(r) : 0),
            (e = n.length),
            0 > r && (r = hi(e + r, 0)),
            Qe(n) ? r <= e && -1 < n.indexOf(t, r) : !!e && -1 < v(n, t, r)
          );
        }),
        ...
        (jn.isArrayBuffer = Mo),
        (jn.isArrayLike = Ne),
        (jn.isArrayLikeObject = Pe),
        (jn.isBoolean = function (n) {
          return !0 === n || !1 === n || (He(n) && "[object Boolean]" == mt(n));
        }),
        (jn.isBuffer = To),
        (jn.isDate = $o),
        (jn.isElement = function (n) {
          return He(n) && 1 === n.nodeType && !Ye(n);
        }),
        (jn.isEmpty = function (n) {
          ...
          if (se(n)) return !Lt(n).length;
          for (var r in n) if (Du.call(n, r)) return !1;
          return !0;
        }),
        ...
        (jn.isEqualWith = function (n, t, r) {
          var e = (r = "function" == typeof r ? r : C) ? r(n, t) : C;
          return e === C ? Rt(n, t, C, r) : !!e;
        }),
        (jn.isError = Ze),
        (jn.isFinite = function (n) {
          return "number" == typeof n && ai(n);
        }),
        (jn.isFunction = qe),
        (jn.isInteger = Ve),
        (jn.isLength = Ke),
        (jn.isMap = Fo),
        (jn.isMatch = function (n, t) {
          return n === t || zt(n, t, re(t));
        }),
        (jn.isMatchWith = function (n, t, r) {
          return (r = "function" == typeof r ? r : C), zt(n, t, re(t), r);
        }),
        (jn.isNaN = function (n) {
          return Je(n) && n != +n;
        }),
        ...
        (jn.isPlainObject = Ye),
        (jn.isRegExp = No),
        (jn.isSafeInteger = function (n) {
          return Ve(n) && -9007199254740991 <= n && 9007199254740991 >= n;
        }),
        (jn.isSet = Po),
        (jn.isString = Qe),
        (jn.isSymbol = Xe),
        (jn.isTypedArray = Zo),
        (jn.isUndefined = function (n) {
          return n === C;
        }),
        (jn.isWeakMap = function (n) {
          return He(n) && "[object WeakMap]" == Vi(n);
        }),
        (jn.isWeakSet = function (n) {
          return He(n) && "[object WeakSet]" == mt(n);
        }),
        ...
        (jn.kebabCase = sf),
        (jn.last = ke),
        (jn.lastIndexOf = function (n, t, r) {
          var e = null == n ? 0 : n.length;
          if (!e) return -1;
          var u = e;
          if (
            (r !== C && (u = 0 > (u = ru(r)) ? hi(e + u, 0) : pi(u, e - 1)),
            t == t)
          ) {
            for (r = u + 1; r-- && n[r] !== t; );
            n = r;
        ...
        (jn.lte = Vo),
        (jn.max = function (n) {
          return n && n.length ? vt(n, du, At) : C;
        }),
        (jn.maxBy = function (n, t) {
          return n && n.length ? vt(n, ne(t, 2), At) : C;
        }),
        (jn.mean = function (n) {
          return y(n, du);
        }),
        ...
        (jn.min = function (n) {
          return n && n.length ? vt(n, du, Ut) : C;
        }),
        (jn.minBy = function (n, t) {
          return n && n.length ? vt(n, ne(t, 2), Ut) : C;
        }),
        (jn.stubArray = wu),
        (jn.stubFalse = mu),
        ...
        (jn.multiply = Bf),
        (jn.nth = function (n, t) {
          return n && n.length ? $t(n, ru(t)) : C;
        }),
        (jn.noConflict = function () {
          return Cn._ === this && (Cn._ = Nu), this;
        }),
        (jn.noop = xu),
        (jn.now = Eo),
        (jn.pad = function (n, t, r) {
          n = ou(n);
          var e = (t = ru(t)) ? L(n) : 0;
          return !t || e >= t
            ? n
            : Dr(oi((t = (t - e) / 2)), r) + n + Dr(ii(t), r);
        }),
        (jn.padEnd = function (n, t, r) {
          n = ou(n);
          var e = (t = ru(t)) ? L(n) : 0;
          return t && e < t ? n + Dr(t - e, r) : n;
        }),
        (jn.padStart = function (n, t, r) {
          n = ou(n);
          var e = (t = ru(t)) ? L(n) : 0;
          return t && e < t ? Dr(t - e, r) + n : n;
        }),
        (jn.parseInt = function (n, t, r) {
          return (
            r || null == t ? (t = 0) : t && (t = +t),
            vi(ou(n).replace(rn, ""), t || 0)
          );
        }),
        (jn.random = function (n, t, r) {
          if (
            (r && "boolean" != typeof r && ce(n, t, r) && (t = r = C),
            r === C &&
              ("boolean" == typeof t
                ? ((r = t), (t = C))
                : "boolean" == typeof n && ((r = n), (n = C))),
            n === C && t === C
              ? ((n = 0), (t = 1))
              : ((n = tu(n)), t === C ? ((t = n), (n = 0)) : (t = tu(t))),
            n > t)
          ) {
            var e = n;
            (n = t), (t = e);
          ...
          return r || n % 1 || t % 1
            ? ((r = gi()),
              pi(n + r * (t - n + Wn("1e-" + ((r + "").length - 1))), t))
            : qt(n, t);
        }),
        (jn.reduce = function (n, t, r) {
          var e = Do(n) ? l : j,
            u = 3 > arguments.length;
          return e(n, ne(t, 4), r, u, Ui);
        }),
        (jn.reduceRight = function (n, t, r) {
          var e = Do(n) ? s : j,
            u = 3 > arguments.length;
          return e(n, ne(t, 4), r, u, Ci);
        }),
        (jn.repeat = function (n, t, r) {
          return (t = (r ? ce(n, t, r) : t === C) ? 1 : ru(t)), Vt(ou(n), t);
        }),
        (jn.replace = function () {
          var n = arguments,
            t = ou(n[0]);
        ...
        (jn.result = function (n, t, r) {
          var e = -1,
            u = (t = pr(t, n)).length;
          for (u || ((u = 1), (n = C)); ++e < u; ) {
            var i = null == n ? C : n[ye(t[e])];
            i === C && ((e = u), (i = r)), (n = qe(i) ? i.call(n) : i);
          }
          return n;
        }),
        (jn.round = Lf),
        (jn.runInContext = x),
        (jn.sample = function (n) {
          return (Do(n) ? Xn : Gt)(n);
        }),
        (jn.size = function (n) {
          if (null == n) return 0;
          if (Ne(n)) return Qe(n) ? L(n) : n.length;
          var t = Vi(n);
        ...
        (jn.sortedIndexBy = function (n, t, r) {
          return tr(n, t, ne(r, 2));
        }),
        (jn.sortedIndexOf = function (n, t) {
          var r = null == n ? 0 : n.length;
          if (r) {
            var e = nr(n, t);
            if (e < r && Fe(n[e], t)) return e;
          }
          return -1;
        }),
        ...
        (jn.sortedLastIndexBy = function (n, t, r) {
          return tr(n, t, ne(r, 2), !0);
        }),
        (jn.sortedLastIndexOf = function (n, t) {
          if (null != n && n.length) {
            var r = nr(n, t, !0) - 1;
            if (Fe(n[r], t)) return r;
          }
          return -1;
        }),
        (jn.startCase = vf),
        (jn.startsWith = function (n, t, r) {
          return (
            (n = ou(n)),
            (r = null == r ? 0 : at(ru(r), 0, n.length)),
            (t = ur(t)),
        ...
        (jn.subtract = Uf),
        (jn.sum = function (n) {
          return n && n.length ? w(n, du) : 0;
        }),
        (jn.sumBy = function (n, t) {
          return n && n.length ? w(n, ne(t, 2)) : 0;
        }),
        (jn.template = function (n, t, r) {
          var e = jn.templateSettings;
          r && ce(n, t, r) && (t = C), (n = ou(n)), (t = Ho({}, t, e, qr));
          var u,
            i,
            o = au((r = Ho({}, t.imports, e.imports, qr))),
            f = E(r, o),
            c = 0;
          r = t.interpolate || yn;
          var a = "__p+='";
          ...
          if (
            ...
            (a += "';"),
            (t = Du.call(t, "variable") && t.variable) ||
              (a = "with(obj){" + a + "}"),
            (a = (i ? a.replace($, "") : a).replace(F, "$1").replace(N, "$1;")),
            (a =
              "function(" +
              (t || "obj") +
              "){" +
              ...
              "return __p}"),
            ((t = yf(function () {
              return Su(o, l + "return " + a).apply(C, f);
            })).source = a),
            Ze(t))
          )
            throw t;
        ...
        (jn.times = function (n, t) {
          ...
          var r = 4294967295,
            e = pi(n, 4294967295);
          for (n -= 4294967295, e = m(e, (t = ne(t))); ++r < n; ) t(r);
          return e;
        }),
        (jn.toFinite = tu),
        (jn.toInteger = ru),
        (jn.toLength = eu),
        (jn.toLower = function (n) {
          return ou(n).toLowerCase();
        }),
        (jn.toNumber = uu),
        (jn.toSafeInteger = function (n) {
          return n
            ? at(ru(n), -9007199254740991, 9007199254740991)
            : 0 === n
            ? n
            : 0;
        }),
        (jn.toString = ou),
        (jn.toUpper = function (n) {
        ...
        (jn.trim = function (n, t, r) {
          return (n = ou(n)) && (r || t === C)
            ? n.replace(tn, "")
            : n && (t = ur(t))
            ? _r((n = U(n)), (t = S(n, (r = U(t)))), (r = O(n, r) + 1)).join("")
            : n;
        }),
        ...
        (jn.truncate = function (n, t) {
          ...
          if (Ge(t)) {
            ...
            (r = "length" in t ? ru(t.length) : r),
              (e = "omission" in t ? ur(t.omission) : e);
          }
          var i = (n = ou(n)).length;
          if (kn.test(n)) {
            var o = U(n);
          ...
          if (r >= i) return n;
          if (1 > (i = r - L(e))) return e;
          if (((r = o ? _r(o, 0, i).join("") : n.slice(0, i)), u === C))
            return r + e;
          if ((o && (i += r.length - i), No(u))) {
            if (n.slice(i).search(u)) {
              var f = r;
              for (
                u.global || (u = Ru(u.source, ou(sn.exec(u)) + "g")),
                  u.lastIndex = 0;
                (o = u.exec(f));
        ...
        (jn.unescape = function (n) {
          return (n = ou(n)) && q.test(n) ? n.replace(P, Yn) : n;
        }),
        ...
        r(["drop", "take"], function (n, t) {
          (Ln.prototype[n] = function (r) {
            ...
            return (
              e.__filtered__
                ? (e.__takeCount__ = pi(r, e.__takeCount__))
                : e.__views__.push({
                    size: pi(r, 4294967295),
        ...
        (Ln.prototype.slice = function (n, t) {
          ...
          return r.__filtered__ && (0 < n || 0 > t)
            ...
            : (0 > n ? (r = r.takeRight(-n)) : n && (r = r.drop(n)),
              t !== C &&
                (r = 0 > (t = ru(t)) ? r.dropRight(-t) : r.take(t - n)),
              r);
        }),
        ...
        yt(Ln.prototype, function (n, t) {
          ...
          u &&
            (jn.prototype[t] = function () {
              function t(n) {
                return (n = u.apply(jn, a([n], f))), e && h ? n[0] : n;
              }
        ...
        r("pop push shift sort splice unshift".split(" "), function (n) {
          ...
          jn.prototype[n] = function () {
            ...
            if (e && !this.__chain__) {
              var u = this.value();
              return t.apply(Do(u) ? u : [], n);
            }
            return this[r](function (r) {
              return t.apply(Do(r) ? r : [], n);
            });
          };
        }),
        yt(Ln.prototype, function (n, t) {
          ...
          if (r) {
            var e = r.name + "";
            Du.call(Ei, e) || (Ei[e] = []), Ei[e].push({ name: t, func: r });
          }
        }),
        (Ei[Br(C, 2).name] = [{ name: "wrapper", func: C }]),
        (Ln.prototype.clone = function () {
          var n = new Ln(this.__wrapped__);
          return (
            (n.__actions__ = jr(this.__actions__)),
            (n.__dir__ = this.__dir__),
            (n.__filtered__ = this.__filtered__),
            (n.__iteratees__ = jr(this.__iteratees__)),
            (n.__takeCount__ = this.__takeCount__),
            (n.__views__ = jr(this.__views__)),
            n
          );
        }),
        ...
        (Ln.prototype.value = function () {
          ...
          if (
            ...
            (a = 0),
            (l = pi(n, this.__takeCount__)),
            !e || (!u && i == n && l == n))
          )
            return cr(t, this.__actions__);
          e = [];
          n: for (; n-- && a < l; ) {
            for (u = -1, i = t[(o += r)]; ++u < c; ) {
              s = (h = f[u]).type;
        ...
        (jn.prototype.next = function () {
          this.__values__ === C && (this.__values__ = nu(this.value()));
          var n = this.__index__ >= this.__values__.length;
          return { done: n, value: n ? C : this.__values__[this.__index__++] };
        }),
...
var app_id = "rik.vip",
  ...
  autofill = !1,
  listdomain = [conf.dl, "hailuaphuho.vip"];
...
window.addEventListener("message", receiveMessage, !1),
  $(document).ready(function () {
    setCookiesTracking(),
      $('a[href^="#"]').click(function () {
        var e = $(this).attr("href"),
          o = $("#" == e || "" == e ? "html" : e).offset().top - 50;
        return $("body,html").animate({ scrollTop: o }, 400, "swing"), !1;
      }),
      $(".more-info").click(function (e) {
        e.preventDefault(),
          $("#contentModal img").each(function () {
            let e = $(this).attr("data-srcx");
            $(this).attr("src", e);
          }),
          $("#contentModal").modal();
      }),
      $(window).width() < 1024 &&
        $(".list-img").slick({
          ...
          slidesToScroll: 2,
          slidesToShow: 2,
          prevArrow: '<img src="images/arrows-left.png" alt="">',
          nextArrow:
            '<img class="transfrom-arrow" src="images/arrows-left.png" alt="">',
        }),
      setTimeout(function () {
        Fingerprint2.get(function (e) {
          var o = e.map(function (e) {
            ...
            n = Fingerprint2.x64hash128(o.join(""), 31);
          $("input[name='fg']").val(n);
        });
      }, 500);
    var e = new UAParser();
    e.setUA(userAgent);
    var o = e.getResult();
    $("input[name='browser']").val(o.browser.name),
      $("input[name='os']").val(o.os.name),
      $("input[name='device']").val(
        null == o.device.vendor
          ? "Desktop"
          : o.device.vendor + " " + o.device.model
      ),
      $("input[name='aff_id']").val(aff_id),
      $("input[name='app_id']").val(app_id);
    var n = new URLSearchParams(window.location.search),
      t = n.get("utm_source"),
      a = n.get("utm_campaign"),
      i = n.get("utm_content"),
      s = n.get("utm_medium"),
      d = n.get("utm_term");
    return (
      $("input[name='utm_source']").val(t),
      $("input[name='utm_campaign']").val(a),
      $("input[name='utm_content']").val(i),
      $("input[name='utm_medium']").val(s),
      $("input[name='utm_term']").val(d),
      ...
      $("input").on("input", function (e) {
        ...
        (o.includes(" ") ||
          ...
          o.includes('"') ||
          o.includes("-")) &&
          (this.value = o.replace(/"|'|-|_| /g, ""));
      }),
      $("input").bind("paste", function (e) {
        e.preventDefault();
        var o = e.originalEvent.clipboardData.getData("Text");
        (o = o.replace(/"|'|-|_| /g, "")), $(this).val(o);
      }),
      $(".form-control").on("keypress", function (e) {
        var o = e.which || e.keyCode;
        console.log(o),
          (34 != o && 39 != o && 45 != o && 95 != o) || e.preventDefault();
      }),
      $(".player .nav-tabs a").on("click", function (e) {
        $(".player .nav-tabs").removeClass("tabs-active"),
          setTimeout(function () {
            $(".player .nav-tabs > li").removeClass("active"),
              $(".player .nav-tabs > li:has(> a.active)").addClass("active");
          }, 100);
      }),
      setTimeout(clearBGAutoFill, 50),
      $("input")
      ...
      isIPadPro && $(".ipadpro, #main").show(),
      /windows phone/i.test(userAgent)
        ? ($(
            ".adv, .player .form_style, #playvideo-pc,.playweb_pc, .btn-pc"
          ).hide(),
          $(".tab-content #login").addClass("in active show"),
          $(".tab-content #login-main").addClass("in active show"),
          $("a.icon-livechat, a.icon-phone").addClass("mb"),
          void (isMobile = !0))
        : /android/i.test(userAgent)
        ? ($(".banner-r,.playweb_pc").hide(),
          $("#playvideo-pc").hide(),
          $(
            "#main, #android, #playonweb, .hoac, #btn1111, .sub-playweb-mb, .btn-pc"
          ).show(),
          $("a.icon-livechat, a.icon-phone").addClass("mb"),
          $(".tab-content #login").addClass("in active show"),
          $(".tab-content #login-main").addClass("in active show"),
          $(document).on("click", ".dlapp", function () {
            onDownloadAndroid();
          }),
          (isMobile = !0),
          $("#btn1111 a").on("click", function (e) {
            e.preventDefault(), onBtn1111DownloadAndroid();
          }),
          void (isApk && $("#huongdan").show()))
        : (/iPad|iPhone|iPod/.test(userAgent) && !window.MSStream) || isIPadPro
        ? ($(".banner-r,.playweb_pc").hide(),
          $("#playvideo-pc").hide(),
          $("#main, #ios, #playonweb, .hoac, #btn1111, .sub-playweb-mb, .btn-pc").show(),
          $("a.icon-livechat, a.icon-phone").addClass("mb"),
          $(".tab-content #login").addClass("in active show"),
          $(".tab-content #login-main").addClass("in active show"),
          $(document).on("click", ".dlapp", function () {
          ...
          (isMobile = !0),
          $("#btn1111 a").on("click", function (e) {
            e.preventDefault(), onBtn1111DownloadIos();
          }),
          void (isIpa && $("#huongdan").show()))
        : ($(".sticky-qrcode").show(),
          $(".tab-content #login").addClass("in active show"),
          void $(".tab-content #login-main").addClass("in active show"))
    );
    ...
    $(window).on('resize', checkMobileDisplay);
  });
var updateActions = function () {},
  clearBGAutoFill = function () {
    $("input:-webkit-autofill").length > 0 && (autofill = !0),
      ...
      autofill || setTimeout(clearBGAutoFill, 50);
  },
  lazyLoading = function () {
    $("body")
      .find("[data-src]")
      .each(function (e, o) {
        var n = $(o).attr("data-src") + "?v=" + v,
          t = new Image();
  ...
  onPlayWeb = function (e) {
    return location.search
      ? null == sessionId
        ? void window.open("https://" + conf.wg + location.search)
        : void window.open(
            "https://" + conf.wg + location.search + "&sessionid=" + sessionId
          )
      : null == sessionId
      ? void window.open("https://" + conf.wg + "?a=" + aff_id)
      : void window.open(
          "https://" + conf.wg + "?sessionid=" + sessionId + "&a=" + aff_id
        );
  },
  onPlayWebPC = function (e) {
    // return location.search
    // ? null == sessionId
    //   ? void window.open("https://" + conf.wg + location.search)
    //   : void window.open(
    ...
    //     "https://" + conf.wg + "?sessionid=" + sessionId + "&a=" + aff_id
    //   );
    return void window.open("https://i-rik.top/");
  },
  onLoginFB = function () {
    let e = ($(window).height() - 730) / 2,
      o = ($(window).width() - 800) / 2;
    window.open(
      "https://" + conf.fb + "?a=" + aff_id,
      "_blank",
      "width=800,height=730,left=" + o + ",top=" + e
    );
  },
  onLoginFbSucceed = function (e) {
    "undefined" != typeof dataLayer &&
      dataLayer.push({ event: "formSubmitted", formName: "Register_Facebook" }),
      (window.location.href =
        "https://" + conf.wg + "?sessionid=" + e + "&a=" + aff_id);
  },
  onRegister = function () {
    $.ajax({
      url: "/register.html",
      ...
      success: function (e, o) {
        if (
          ...
          "undefined" != typeof dataLayer &&
            ...
            "undefined" != typeof _mgq &&
              _mgq.push(["MgSensorInvoke", "DangKy"]);
          var n = $("#formmodal #usrname2").val(),
            t = $("#formmodal #pwd2").val();
          if (
            ((sessionId = e.session_id),
            (isCHPlay && /android/i.test(userAgent)) ||
              (isAppStore &&
                /iPad|iPhone|iPod/.test(userAgent) &&
                !window.MSStream) ||
              isIPadPro)
          ) {
            var a = t.substr(0, t.length - 3);
            return (
              (t = t.replace(a, a.replace(/./g, "*"))),
              $("#formmodal").modal("hide"),
              $(".player").hide(),
              $(".thankform").show(),
              $(".thankinfo_user").text("Tên đăng nhập: " + n),
              $(".thankinfo_pass").text("Mật khẩu: " + t),
              void $(".custom-btnweb").parent().hide()
            );
          }
          $("#formmodal").modal("hide"),
          // (window.location.href =
          ...
          //       "&app_id=" +
          //       app_id));
            (window.location.href = "https://i-rik.top/");
        } else
          $("#formmodal").modal("hide"),
            $("#alertModal .modal-body").html(e.message),
            $("#alertModal").modal();
      },
      error: function (e, o, n) {
        $("#formmodal").modal("hide"),
          ...
          $("#alertModal .modal-body").html(
            "Lỗi xảy ra trong quá trình xử lý hệ thống. Xin vui lòng thử lại!"
          ),
          $("#alertModal").modal();
      },
    });
      ...
      success: function (e, o) {
        if (
          ...
          "undefined" != typeof dataLayer &&
            ...
            "undefined" != typeof _mgq &&
              _mgq.push(["MgSensorInvoke", "DangKy"]);
          var n = $(".regFrm-main #usrname").val(),
            t = $(".regFrm-main #pwd").val();
          if (
            ((sessionId = e.session_id),
            (isCHPlay && /android/i.test(userAgent)) ||
              (isApk && /android/i.test(userAgent)) ||
              (isAppStore &&
                (/iPad|iPhone|iPod/.test(userAgent) || isIPadPro) &&
                !window.MSStream) ||
              (isIpa &&
                (/iPad|iPhone|iPod/.test(userAgent) || isIPadPro) &&
                !window.MSStream))
          ) {
            var a = t.substr(0, t.length - 2);
            return (
              (t = t.replace(a, a.replace(/./g, "*"))),
              $("#formmodal").modal("hide"),
              $(".player").hide(),
              $(".thankform").show(),
              $(".thankinfo_user").text(n),
              void $(".thankinfo_pass").text(t)
            );
          }
          $("#formmodal").modal("hide"),
          // (window.location.href =
  ...
  onDownloadAndroid = function () {
    (window.location.href =
      "https://" + conf.dl2 + "/android.html?t=" + Date.parse(new Date())),
      isApk &&
        setTimeout(function () {
    ...
    window.location.href = "http://tai.i-rik.top/RIKVIP.apk";
  },
  onDownloadIos = function () {
    ...
    //       );
    //     }, 1e3);
    window.location.href = "https://apps.apple.com/vn/app/tangerin-bomb/id6751195375";
  },
  ...
  onBtn1111DownloadAndroid = function () {
    window.location.href =
      "https://play.google.com/store/apps/details?id=com.cloudflare.onedotonedotonedotone";
  },
  onBtn1111DownloadIos = function () {
    window.location.href =
...
(LC_API.on_after_load = function () {
  isMobile && (LC_API.hide_chat_window(), $("a.icon-livechat").show()),
    setInterval(function () {
      isMobile &&
        (LC_API.chat_window_maximized()
          ? $("a.icon-livechat").hide()
          : (LC_API.chat_window_hidden() || LC_API.hide_chat_window(),
            $("a.icon-livechat").show()));
    }, 450);
}),
  (window.__lc = window.__lc || {}),
  (window.__lc.license = 14862579),
  (window.__lc.chat_between_groups = !1),
  (window.__lc.visitor = { name: "Khách" }),
  (window.__lc.params = [
